    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        default="", max_length=100, verbose_name="Activity type"
                    ),
                ),
                (
                    "slug",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        default="", max_length=100, verbose_name="Condition Type"
                    ),
                ),
                (
                    "resume",
                    models.CharField(
                        default="", max_length=100, verbose_name="Condition resume"
                    ),
                ),
                (
                    "description",
                    models.TextField(default="", verbose_name="Condition description"),
                ),
                (
                    "price",
                    models.IntegerField(blank=True, default=5, verbose_name="Price"),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "available_seats",
                    models.IntegerField(
                        blank=True, default=0, verbose_name="Available seats"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "picture",
                    models.ImageField(
                        null=True, upload_to="organizations/", verbose_name="Image"
                    ),
                ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=models.SET(plateformeweb.models.PlaceType.get_other_place),
