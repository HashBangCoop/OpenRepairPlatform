    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activity', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='event.Activity')),
                ('condition', models.ManyToManyField(blank=True, related_name='condition_activity', to='event.Condition', verbose_name='Conditions')),
            ],
        ),
    ]
